...
DATABASES = {
    'default': {
        ...
        'NAME': 'projectdatabase1', # database name in RDS is written here
        'USER': 'admin', # database master username in RDS is written here
        'PASSWORD': config('PASSWORD'),
        'HOST': 'database-1.con76kc9s0ti.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'project-bucket-acl' # please enter your s3 bucket name
