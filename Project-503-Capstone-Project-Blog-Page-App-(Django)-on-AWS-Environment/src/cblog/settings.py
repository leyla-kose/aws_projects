...
DATABASES = {
    'default': {
        ...
        'HOST': 'projectdatabase.con76kc9s0ti.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'project-bucket-leyla' # please enter your s3 bucket name
